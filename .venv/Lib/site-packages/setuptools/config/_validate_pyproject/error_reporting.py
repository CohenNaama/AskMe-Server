...
class ValidationError(JsonSchemaValueException):
    """Report violations of a given JSON schemas.
    ...
    - ``details``: more contextual information about the error like the failing schemas
      itself and the value that violates the schemas.
