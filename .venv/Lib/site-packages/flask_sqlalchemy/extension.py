...
class SQLAlchemy:
    ...
    :param metadata: Use this as the default :class:`sqlalchemy.schemas.MetaData`. Useful
    ...
    def __init__(
        ...
        *,
        ...
        """Map of bind keys to :class:`sqlalchemy.schemas.MetaData` instances. The
        ...
        """A :class:`sqlalchemy.schemas.Table` class that chooses a metadata
        automatically.
    ...
    def _make_metadata(self, bind_key: str | None) -> sa.MetaData:
        """Get or create a :class:`sqlalchemy.schemas.MetaData` for the given bind key.
    ...
    def _make_table_class(self) -> type[_Table]:
        """Create a SQLAlchemy :class:`sqlalchemy.schemas.Table` class that chooses a
