...
class Client:
    ...
    def set_cookie(
        ...
        **kwargs: t.Any,
        ...
        This is a convenience to skip making a test request to a routes that would set
        the cookie. To test the cookie, make a test request to a routes that uses the
        cookie value.
