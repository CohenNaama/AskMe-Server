...
class SerializerMixin:
    ...
    def to_dict(self, only=(), rules=(),
        ...
        :param only: exclusive schemas to replace default one (always have higher priority than rules)
        :param rules: schemas to extend default one or schemas defined in "only"
...
class Serializer:
    ...
    def __call__(self, value, only=(), extend=()):
        ...
        :param only: Exclusive schemas of serialization
        :param extend: Rules that extend default schemas
